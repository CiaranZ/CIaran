...
public final class bools_t implements lcm.lcm.LCMEncodable
{
    ...
    public lcmtest.bools_t copy()
    {
        ...
        if (this.num_a > 0)
            System.arraycopy(this.one_dim_array, 0, outobj.one_dim_array, 0, (int) this.num_a); 
        outobj.two_dim_array = new boolean[(int) num_a][(int) num_b];
        for (int a = 0; a < this.num_a; a++) {
            if (this.num_b > 0)
                System.arraycopy(this.two_dim_array[a], 0, outobj.two_dim_array[a], 0, (int) this.num_b);        }
