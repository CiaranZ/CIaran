...
CMakeFiles/dist_targz:
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --blue --bold --progress-dir=/mnt/nvme1n1p7/HKUST_ws/src/pinocchio/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Generating tar.gz tarball and its signature..."
	/usr/bin/tar -czf pinocchio-2.5.1.tar.gz pinocchio-2.5.1/ && /usr/bin/gpg --detach-sign --armor -o /mnt/nvme1n1p7/HKUST_ws/src/pinocchio/pinocchio-2.5.1.tar.gz.sig /mnt/nvme1n1p7/HKUST_ws/src/pinocchio/pinocchio-2.5.1.tar.gz
...
CMakeFiles/dist_targz.dir/depend:
	cd /mnt/nvme1n1p7/HKUST_ws/src/pinocchio && $(CMAKE_COMMAND) -E cmake_depends "Unix Makefiles" /mnt/nvme1n1p7/HKUST_ws/src/pinocchio /mnt/nvme1n1p7/HKUST_ws/src/pinocchio /mnt/nvme1n1p7/HKUST_ws/src/pinocchio /mnt/nvme1n1p7/HKUST_ws/src/pinocchio /mnt/nvme1n1p7/HKUST_ws/src/pinocchio/CMakeFiles/dist_targz.dir/DependInfo.cmake --color=$(COLOR)
